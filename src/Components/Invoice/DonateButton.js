export default function DonateButton() {
    return (
      <>
        ...
        <div className="flex">
          <a
            href="http://share.payoneer.com/nav/ODCnriR5crCQEUvgGr8eoID_EphdLk3GjF8Pr_6Pwbn5obisKFJ25_EfigNgz7Vd8okUecqleXKGdUqs4UrwIA2"
            // href="https://www.paypal.com/donate/?hosted_button_id=U6J5KFC2KH8XG"
            target="_blank"
            rel="noreferrer"
            className="bg-yellow-500 py-2 px-6 rounded text-base hover:bg-transparent border-2 text-white transition-all duration-500 hover:text-red-500 hover:border-red-500 shadow-lg flex items-center"
          >
            Donate to Creator
          </a>
        </div>
